...
'''
I have sinced changed all the xG values to be calculated by a Neural network so this file is no longer needed as it
calculates xG using the old exponential formaula
'''
