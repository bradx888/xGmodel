...
shots = ax.scatter(data[(data.Header == 0) & (data.Scored == 'Missed')]['y'],
...
headers = ax.scatter(data[(data.Header == 1) & (data.Scored == 'Missed')]['y'],
...
shots = ax.scatter(data[(data.Header == 0) & (data.Scored == 'Scored')]['y'],
...
headers = ax.scatter(data[(data.Header == 1) & (data.Scored == 'Scored')]['y'],
...
plt.axis('off')
fig.savefig('./xG Plots/Players/' + player_name + ' ' + datetime.today().strftime("%Y-%m-%d") + '.png',
