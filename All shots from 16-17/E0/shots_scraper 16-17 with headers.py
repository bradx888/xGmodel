...
data = pd.read_csv('/Users/BradleyGrantham/Documents/Python/FootballPredictions/xG model/Football-data.co.uk/E0/16-17.csv')
data['Date'] = pd.to_datetime(data['Date'], format='%d/%m/%y')

mappings = pd.read_csv('/Users/BradleyGrantham/Documents/Python/FootballPredictions/xG model/All shots from 16-17/E0/mappings.csv', index_col=0, header=None)
